...
namespace PrintDiamond.UnitTests.DiamondStringBuilder
{
    ...
    public class DiamondStringBuilderTest
    {
        ...
        public void CorrectNumberOfCharacterA(char character)
        {
            ...
            Assert.AreEqual(1, result.Count(s => s == character));
        }
        ...
        {
            var expected = File.ReadAllText(Path.Combine(TestContext.CurrentContext.TestDirectory, "DiamondStringBuilder", $"CorrectDiamondStructure{character}.txt"));
